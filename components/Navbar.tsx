  ...
  return (
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        >
          <span className="text-xl font-bold text-textGreen">Rue</span>
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <a href="/assets/jarue_johnson_resume_2023.pdf" target="_blank">
                  <motion.button
                    ...
                    className=" text-textGreen w-32 h-10 rounded-md text-[13px] border border-textGreen hover:bg-hoverColor duration-300"
                  >
                    Resume
                  </motion.button>
                </a>
                ...
                >
                  <button className=" text-center text-sm w-72  font-titleFont tracking-widest  duration-300 text-textGreen">
