...
function About() {
  const technologies = [
    { name: "HTML5", url: "https://developer.mozilla.org/en-US/docs/Glossary/HTML5" },
    { name: "Tailwind", url: "https://tailwindcss.com/" },
    { name: "Flowbite", url: "https://flowbite.com/" },
    { name: "SASS", url: "https://sass-lang.com/guide/" },
    { name: "JS (ES6+)", url: "http://es6-features.org/" },
    ...
    { name: "Cypress", url: "https://www.cypress.io/app/?gad=1" },
